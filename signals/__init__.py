...
receivepayment_created = Signal(providing_args=["qbd_model_mixin_obj","realm_id"])
receivepayment_updated = Signal(providing_args=["qbd_model_mixin_obj","realm_id"])
...
itemnoninventory_created = Signal(providing_args=["qbd_model_mixin_obj", "realm_id"])
itemnoninventory_updated = Signal(providing_args=["qbd_model_mixin_obj", "realm_id"])
billpaymentcheck_created = Signal(providing_args=["qbd_model_mixin_obj", "realm_id"])
billpaymentcheck_updated = Signal(providing_args=["qbd_model_mixin_obj", "realm_id"])
